...
func (m *Metrics) CacheHits(n int64) { m.cacheHits.Add(context.Background(), n) }

// CacheMisses records n cache reads that fell through to a loader.
func (m *Metrics) CacheMisses(n int64) { m.cacheMisses.Add(context.Background(), n) }

// LockContended records n waits on a lock held by another caller.
func (m *Metrics) LockContended(n int64) { m.lockContended.Add(context.Background(), n) }

// LockWaitDuration records the time spent waiting on a contended lock.
func (m *Metrics) LockWaitDuration(d time.Duration) {
	m.lockWaitDuration.Record(context.Background(), d.Seconds())
}
...
func (m *Metrics) LoaderDuration(d time.Duration) {
	m.loaderDuration.Record(context.Background(), d.Seconds())
}

// LoaderErrors records that a foreground loader returned an error; n is the
// number of keys it was responsible for.
func (m *Metrics) LoaderErrors(n int64) { m.loaderErrors.Add(context.Background(), n) }

// RefreshTriggered records n background refreshes started.
func (m *Metrics) RefreshTriggered(n int64) { m.refreshTriggered.Add(context.Background(), n) }

// RefreshSkipped records n background refreshes deduped (local or distributed).
func (m *Metrics) RefreshSkipped(n int64) { m.refreshSkipped.Add(context.Background(), n) }

// RefreshDropped records n background refreshes dropped because the queue was full.
func (m *Metrics) RefreshDropped(n int64) { m.refreshDropped.Add(context.Background(), n) }
...
func (m *Metrics) RedisError(op string) {
	m.redisErrors.Add(context.Background(), 1, metric.WithAttributes(attribute.String("op", op)))
}
...
func (m *Metrics) LockLost(string) { m.lockLost.Add(context.Background(), 1) }
...
func (m *Metrics) RefreshError(string) { m.refreshErrors.Add(context.Background(), 1) }

// RefreshPanicked records a background refresh callback panic. The key is
// deliberately not attached as an attribute to avoid unbounded cardinality.
func (m *Metrics) RefreshPanicked(string) { m.refreshPanicked.Add(context.Background(), 1) }

// InvalidationError records an invalidation message that failed to parse.
func (m *Metrics) InvalidationError() { m.invalidationErrors.Add(context.Background(), 1) }
