...
```bash
scripts/bench-compare.sh v0.2.0           # compares v0.2.0 vs most-recent
scripts/bench-compare.sh v0.2.0 v0.3.0    # compares two named runs
```
...
2. On the release commit, before tagging: `scripts/bench.sh <new-version>`.
3. `scripts/bench-compare.sh <prev-version> <new-version>`.
